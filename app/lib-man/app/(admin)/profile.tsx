...
const ProfileScreen = () => {
  ...
  const [activeSheet, setActiveSheet] = useState<'profile' | 'users' | null>(null);
            ...
            <View>
              ...
              <View className="mt-4">
                <Text className="text-lg" style={{ color: headingColor }}>
                  Name: <Text style={{ color: theme === 'dark' ? '#D1D5DB' : '#6B7280' }}>{adminProfile.name}</Text>
                </Text>
                <Text className="text-lg mt-2" style={{ color: headingColor }}>
                  Email: <Text style={{ color: theme === 'dark' ? '#D1D5DB' : '#6B7280' }}>{adminProfile.email}</Text>
                </Text>
                <Text className="text-lg mt-2" style={{ color: headingColor }}>
                  Role: <Text style={{ color: theme === 'dark' ? '#D1D5DB' : '#6B7280' }}>{adminProfile.role}</Text>
                </Text>
              </View>
            </View>
          ) : activeSheet === 'users' ? (
